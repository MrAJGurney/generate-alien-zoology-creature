...
// Note: These methods were used to generate the JSON dictionaries in source-files\creature-genes.js and source-files\creature-action-cards.js
...
const CREATURE_ACTION_CARDS = actionsText
                            .trim()
                            .split(`\n\n`)
                            .map(actionText => {
